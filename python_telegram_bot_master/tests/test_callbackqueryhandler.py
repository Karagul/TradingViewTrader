...
from python_telegram_bot_master.telegram import (Update, CallbackQuery, Bot, Message, User, Chat, InlineQuery,
                      ChosenInlineResult, ShippingQuery, PreCheckoutQuery)
from python_telegram_bot_master.telegram.ext import CallbackQueryHandler, CallbackContext, JobQueue
