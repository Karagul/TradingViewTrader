...
import sys
import warnings
from python_telegram_bot_master.telegram.vendor.ptb_urllib3.urllib3.fields import RequestField
# import python_telegram_bot_master.telegram.vendor.ptb_urllib3
# import python_telegram_bot_master.telegram.vendor.ptb_urllib3.urllib3.contrib.appengine
...
try:
    from python_telegram_bot_master.telegram.vendor.ptb_urllib3 import urllib3
    from python_telegram_bot_master.telegram.vendor.ptb_urllib3.urllib3.contrib import appengine as appengine
    from python_telegram_bot_master.telegram.vendor.ptb_urllib3.urllib3.connection import HTTPConnection
    from python_telegram_bot_master.telegram.vendor.ptb_urllib3.urllib3.util.timeout import Timeout
    from python_telegram_bot_master.telegram.vendor.ptb_urllib3.urllib3.fields import RequestField
...
from python_telegram_bot_master.telegram import (InputFile, TelegramError, InputMedia)
from python_telegram_bot_master.telegram.error import (Unauthorized, NetworkError, TimedOut, BadRequest, ChatMigrated,
...
class Request(object):
    ...
    def __init__(self,
        ...
        if not proxy_url:
            ...
            if proxy_url.startswith('socks'):
                try:
                    from python_telegram_bot_master.telegram.vendor.ptb_urllib3.urllib3.contrib.socks import SOCKSProxyManager
                except ImportError:
    ...
    def _parse(json_data):
        """Try and parse the JSON returned from python_telegram_bot_master.telegram.
