...
from python_telegram_bot_master.telegram import (TelegramObject, PassportFile, PersonalDetails, IdDocumentData,
                      ResidentialAddress)
from python_telegram_bot_master.telegram.passport.credentials import decrypt_json
