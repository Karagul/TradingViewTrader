...
from python_telegram_bot_master.telegram import User, TelegramObject
from python_telegram_bot_master.telegram.utils.helpers import to_timestamp, from_timestamp
