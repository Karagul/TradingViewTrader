...
from python_telegram_bot_master.telegram import TelegramError
from python_telegram_bot_master.telegram.error import Unauthorized, InvalidToken, NetworkError, BadRequest, TimedOut, \
