...
from python_telegram_bot_master.telegram import (CallbackQuery, Chat, ChosenInlineResult, InlineQuery, Message,
                      PreCheckoutQuery, ShippingQuery, Update, User, MessageEntity)
from python_telegram_bot_master.telegram.ext import (ConversationHandler, CommandHandler, CallbackQueryHandler,
