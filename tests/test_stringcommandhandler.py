...
from python_telegram_bot_master.telegram import (Bot, Update, Message, User, Chat, CallbackQuery, InlineQuery,
                      ChosenInlineResult, ShippingQuery, PreCheckoutQuery)
from python_telegram_bot_master.telegram.ext import StringCommandHandler, CallbackContext, JobQueue
